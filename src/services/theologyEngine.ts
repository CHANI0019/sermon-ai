...
export class TheologyEngineService {
  ...
  public static async counselPastoral(queryInput: string): Promise<PastoralCareResult> {
    ...
    return {
      ...
      aiLimitationNotice: '⚠️ [Project LOGOS AI 안내]: 본 답변은 인공지능이 성경 66권과 정통 신학에 기초하여 제공한 묵상 참고자료입니다. 영적 중생과 은혜는 성령 하나님과 성도님이 속하신 지역 교회 공동체를 통해 이뤄집니다.'
    };
  }
